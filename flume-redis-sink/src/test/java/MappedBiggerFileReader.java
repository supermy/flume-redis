 ...
 * 结论：逐行读取 BufferRead 与 MappedBufArry 效率相差无几......
 */
public class MappedBiggerFileReader {
    static String path = "/Users/moyong/project/env-myopensource/3-tools/mytools/alpine/flume/conf/data/01_01_20170701110231740.txt";
    ...
    public static void main(String[] args) throws IOException {
        MappedBiggerFileReader reader = new MappedBiggerFileReader(path, 65536);
